...
public class HttpDataUpdateHandler implements HttpRequestHandler {

	private static Logger log = Logger.getLogger(HttpDataUpdateHandler.class);
	...
	public void handle(final HttpRequest request, final HttpResponse response,
		...
		if (method.equals("POST")) {
			...
			if (tweet != null) {
				TweetsLib.processTweet(URLDecoder.decode(tweet,"UTF-8"));
